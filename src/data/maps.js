...
export const MAP_DEFS = {
  ...
  holt_house: {
    ...
    interactables: [],
    npcs: [
      { id: "tobin", name: "Tobin Holt", sheet: "tobin", x: 2, y: 3, wanderRange: 1, dialogueId: "tobin" },
      { id: "yssa", name: "Yssa Holt", sheet: "yssa", x: 4, y: 3, wanderRange: 1, dialogueId: "yssa" },
      { id: "wren", name: "Wren Holt", sheet: "wren", x: 6, y: 3, wanderRange: 1, dialogueId: "wren" },
    ],
    enemies: [],
    triggers: [],
  },
  ...
  ashwood_house: {
    ...
    interactables: [],
    npcs: [
      { id: "garrick", name: "Garrick Ashwood", sheet: "garrick", x: 2, y: 3, wanderRange: 1,
        dialogueId: (s) => (s.flags.knifeReceived ? "garrick_return" : "garrick") },
      { id: "mira", name: "Mira Ashwood", sheet: "mira", x: 4, y: 3, wanderRange: 1, dialogueId: "mira" },
      { id: "pell", name: "Pell Ashwood", sheet: "pell", x: 6, y: 3, wanderRange: 1, dialogueId: "pell" },
    ],
    enemies: [],
    triggers: [],
  },
  ...
  sela_house: {
    ...
    interactables: [],
    npcs: [{ id: "sela", name: "Sela Vane", sheet: "sela", x: 4, y: 2, wanderRange: 1, dialogueId: "sela" }],
    enemies: [],
    triggers: [],
  },
};
