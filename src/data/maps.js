...
export const MAP_DEFS = {
  hollow: {
    ...
    doors: [
      ...
      { x: 16, y: 8, to: "holt_house", spawn: { x: 5, y: 6, facing: "up" } },
      { x: 17, y: 13, to: "ashwood_house", spawn: { x: 5, y: 6, facing: "up" } },
  ...
  // Interiors use two full-width open walkway rows (2 and 4) sandwiching a
  // furniture row (3) and a hearth row (5), so every piece of furniture is
  // reachable from an open tile -- no dead-end pockets to get stuck in.
  holt_house: {
    id: "holt_house",
    ...
    doors: [{ x: 5, y: 7, to: "hollow", spawn: { x: 16, y: 9, facing: "down" } }],
    interactables: [],
    npcs: [
      { id: "yssa", name: "Yssa Holt", sheet: "yssa", x: 7, y: 4, wanderRange: 1,
        hideIf: (s) => s.flags.horn, dialogueId: "yssa" },
      { id: "wren", name: "Wren Holt", sheet: "wren", x: 9, y: 4, wanderRange: 1,
  ...
  ashwood_house: {
    ...
    doors: [{ x: 5, y: 7, to: "hollow", spawn: { x: 17, y: 14, facing: "down" } }],
    interactables: [],
    npcs: [
      { id: "mira", name: "Mira Ashwood", sheet: "mira", x: 7, y: 4, wanderRange: 1,
  ...
  sela_house: {
    ...
    doors: [{ x: 4, y: 7, to: "hollow", spawn: { x: 3, y: 14, facing: "down" } }],
    interactables: [],
    npcs: [
      { id: "sela", name: "Sela Vane", sheet: "sela", x: 5, y: 4, wanderRange: 1,
