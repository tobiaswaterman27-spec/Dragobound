  ...
  joran_intro: {
    ...
    nodes: {
      root: {
        ...
        text: "Couldn't sleep either, huh?|Feels wrong, doesn't it. Same cracked walls, same eleven doors, same wasteland past the fence line. Some mornings I forget there's a whole world past the Greywood.|Nobody's opened that gate in longer than I can remember. Wonder what's actually out there now.",
        next: null,
        else: "again",
      },
      again: {
